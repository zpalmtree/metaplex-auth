...
describe('NFTBundle', () => {
  describe('addNFT', () => {
    it('adds an entry to the manifest', async () => {
      ...
      expect(
        (_a = manifest['an-id']) === null || _a === void 0
          ? void 0
          : _a.encodedAssets.cid
      ).to.eq(nft.encodedAssets.cid)
      expect(
        (_b = manifest['an-id']) === null || _b === void 0
          ? void 0
          : _b.encodedMetadata.cid
      ).to.eq(nft.encodedMetadata.cid)
    })
  ...
  describe('addNFTFromFileSystem', () => {
    ...
    it('assigns an id based on metadata filename if none is given', async () => {
      ...
      expect(
        (_a = manifest['token']) === null || _a === void 0
          ? void 0
          : _a.encodedAssets.cid
      ).to.eq(nft.encodedAssets.cid)
      expect(
        (_b = manifest['token']) === null || _b === void 0
          ? void 0
          : _b.encodedMetadata.cid
      ).to.eq(nft.encodedMetadata.cid)
    })
...
async function expectRootBlockToHaveCIDs(
  ...
  for (const link of links) {
    ...
    expect(
      metadataCIDs.some((cid) =>
        cid.equals(
          metadataLink === null || metadataLink === void 0
            ? void 0
            : metadataLink.Hash
        )
      )
    ...
    expect(
      assetCIDs.some((cid) =>
        cid.equals(
          assetsLink === null || assetsLink === void 0
            ? void 0
            : assetsLink.Hash
        )
      )
